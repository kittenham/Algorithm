...
2023년 11월 3일 14:27:50

### 문제 설명

<p style="user-select: auto;">양의 정수 <code style="user-select: auto;">x</code>가 하샤드 수이려면 <code style="user-select: auto;">x</code>의 자릿수의 합으로 <code style="user-select: auto;">x</code>가 나누어져야 합니다. 예를 들어 18의 자릿수 합은 1+8=9이고, 18은 9로 나누어 떨어지므로 18은 하샤드 수입니다. 자연수 <code style="user-select: auto;">x</code>를 입력받아 <code style="user-select: auto;">x</code>가 하샤드 수인지 아닌지 검사하는 함수, solution을 완성해주세요.</p>
...
<p style="user-select: auto;">※ 공지 - 2023년 5월 27일 문제 지문 오탈자 수정되었습니다.</p>
